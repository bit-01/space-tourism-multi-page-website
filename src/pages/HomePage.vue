<template>
  <div class="row">
    <div class="col-lg-7">
      <div class="col-md-7 col-9 headContainer" style="margin: 0 auto">
    ...
    <div class="col-lg-5 explore">
      <router-link :to="{ name: 'destination' }" class="circle font-bellafair">
        <span> Explore </span>
...
.circle:hover .outerCircle,
.circle:focus .outerCircle {
